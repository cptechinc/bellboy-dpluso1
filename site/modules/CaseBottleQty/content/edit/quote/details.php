					...
					<div class="row">
						...
						<div class="col-md-1 form-group sm-padding">
							...
							<span class="detail-line-field numeric">
								<input class="form-control input-xs text-right underlined" type="text" size="6" name="case-qty" value="<?= $detail->quotqty + 0; ?>">
							</span>
						</div>
						<div class="col-md-1 form-group sm-padding">
							<span class="detail-line-field-name">Bottle Qty:</span>
							<span class="detail-line-field numeric">
								<input class="form-control input-xs text-right underlined" type="text" size="6" name="bottle-qty" value="<?= $detail->quotqty + 0; ?>">
							</span>
						</div>
						<div class="col-md-1 form-group sm-padding">
