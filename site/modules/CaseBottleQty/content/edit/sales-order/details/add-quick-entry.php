		...
		<div class="col-xs-9 sm-padding">
			<div class="row">
				...
				<div class="col-md-1 form-group sm-padding">
					...
					<span class="detail-line-field numeric">
						<input class="form-control input-xs text-right underlined" type="text" size="6" name="case-qty" value="">
					</span>
				</div>
	            <div class="col-md-1 form-group sm-padding">
					<span class="detail-line-field-name">Qty:</span>
					<span class="detail-line-field numeric">
						<input class="form-control input-xs text-right underlined" type="text" size="6" name="bottle-qty" value="">
					</span>
				</div>
