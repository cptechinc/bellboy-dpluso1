	...
	<form action="<?= $config->pages->cart.'redir/'; ?>" method="post" class="form-group allow-enterkey-submit">
		...
		<div class="row">
			<div class="col-sm-9 form-group">
				<div class="row">
					<div class="col-md-3 sm-padding form-group">
					...
					<div class="col-md-2 sm-padding form-group">
						...
						<p class="form-control-static text-right"><span class="detail-line-field numeric">$ <?= $page->stringerbell->format_money($detail->totalprice); ?></span></p>
					</div>
					<div class="col-md-2 sm-padding form-group">
...
<?php endforeach; ?>
<?php include $config->paths->siteModules.'CaseBottleQty/content/cart/add-quick-entry.php'; ?>
