	...
	<div class="col-xs-6">
		<div class="row">
			<table class="pull-right">
				<tr> <td class="col-xs-6"><label>Order Date:</label></td> <td class="col-xs-6 text-right"><?= $order->order_date; ?></td> </tr>
				<tr> <td class="col-xs-6"><label>Request Date:</label></td> <td class="col-xs-6 text-right"><?= $order->request_date; ?></td> </tr>
				...
				<?php if (array_key_exists($order->salesperson_1, $salespersonjson['data'])) : ?>
