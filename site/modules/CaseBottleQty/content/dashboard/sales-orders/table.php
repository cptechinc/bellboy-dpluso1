<table class="table table-striped table-bordered table-condensed" id="orders-table">
	<thead>
		<?php include $config->paths->siteModules.'CaseBottleQty/content/dashboard/sales-orders/thead-rows.php'; ?>
	</thead>
	<tbody>
		...
		<?php foreach($orderpanel->orders as $order) : ?>
			...
			<?php if ($order->ordernumber == $input->get->text('ordn')) : ?>
				<?php if ($input->get->show == 'documents' && (!$input->get('item-documents'))) : ?>
					<?php include $config->paths->siteModules.'CaseBottleQty/content/dashboard/sales-orders/documents-rows.php'; ?>
				<?php endif; ?>

				<?php include $config->paths->siteModules.'CaseBottleQty/content/dashboard/sales-orders/detail-rows.php'; ?>

				<?php include $config->paths->siteModules.'CaseBottleQty/content/dashboard/sales-orders/total-rows.php'; ?>

				<?php if ($input->get->text('show') == 'tracking') : ?>
					<?php include $config->paths->siteModules.'CaseBottleQty/content/dashboard/sales-orders/tracking-rows.php'; ?>
				<?php endif; ?>

			<?php if ($order->has_error() == 'Y') : ?>
