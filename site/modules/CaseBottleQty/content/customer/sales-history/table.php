...
<table class="table table-striped table-bordered table-condensed order-listing-table">
	<thead>
		<?php include $config->paths->siteModules.'CaseBottleQty/content/customer/sales-history/thead-rows.php'; ?>
	</thead>
	<tbody>
		...
		<?php foreach($orderpanel->orders as $order) : ?>
			...
			<?php if ($order->ordernumber == $input->get->text('ordn')) : ?>
				<?php if ($input->get->show == 'documents' && (!$input->get('item-documents'))) : ?>
					<?php include $config->paths->siteModules.'CaseBottleQty/content/customer/sales-history/documents-rows.php'; ?>
				<?php endif; ?>

				<?php include $config->paths->siteModules.'CaseBottleQty/content/customer/sales-history/detail-rows.php'; ?>

				<?php include $config->paths->siteModules.'CaseBottleQty/content/customer/sales-history/totals-rows.php'; ?>

				<?php if ($input->get->text('show') == 'tracking') : ?>
					<?php include $config->paths->siteModules.'CaseBottleQty/content/customer/sales-history/tracking-rows.php'; ?>
				<?php endif; ?>
