...
<table class="table table-striped table-bordered table-condensed" id="quotes-table">
	<thead>
       <?php include $config->paths->siteModules.'CaseBottleQty/content/customer/quotes/thead-rows.php'; ?>
    </thead>
	<tbody>
		...
		<?php foreach ($quotepanel->quotes as $quote) : ?>
			...
			<?php if ($quote->quotnbr == $input->get->text('qnbr')) : ?>
	            ...
	            <?php endif; ?>
				<?php include $config->paths->siteModules.'CaseBottleQty/content/customer/quotes/detail-rows.php'; ?>
				<?php include $config->paths->siteModules.'CaseBottleQty/content/customer/quotes/totals-rows.php'; ?>
