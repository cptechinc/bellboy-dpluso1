	...
	<div class="row">
		...
		<div class="col-sm-2">
			...
			<div class="input-group form-group">
				<input class="form-control form-group inline input-sm" type="text" name="total_order[]" id="cust-order-total-min" value="<?= $orderpanel->get_filtervalue('ordertotal'); ?>" placeholder="From Order Total">
			...
			<div class="input-group form-group">
				<input class="form-control form-group inline input-sm" type="text" name="[]" id="cust-order-total-max" value="<?= $orderpanel->get_filtervalue('ordertotal', 1); ?>" placeholder="Through Order Total">
	            <span class="input-group-btn">
