                ...
                switch ($addtype) {
                    case 'cart':
                        if ($modules->isInstalled('CaseBottleQty')) {
                            include $config->paths->siteModules.'CaseBottleQty/content/item-search/add-detail/cart.php';
                        } else {
                    ...
                    case 'order':
                        if ($modules->isInstalled('CaseBottleQty')) {
                            include $config->paths->siteModules.'CaseBottleQty/content/item-search/add-detail/sales-order.php';
                        } else {
                    ...
                    case 'quote':
                        if ($modules->isInstalled('CaseBottleQty')) {
                            include $config->paths->siteModules.'CaseBottleQty/content/item-search/add-detail/quote.php';
                        } else {
