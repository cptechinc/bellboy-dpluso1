	...
	<div class="panel-heading not-round" id="cust-sales-history-panel-heading">
	 ...
	 <div id="cust-sales-history-div" class="<?= $orderpanel->collapse; ?>">
			...
			<div id="cust-sales-history-search-div" class="<?= (empty($orderpanel->filters) || empty($input->get->filter)) ? 'collapse' : ''; ?>">
				<?php
					if ($modules->isInstalled('CaseBottleQty')) {
						include $config->paths->siteModules.'CaseBottleQty/content/customer/sales-history/search-form.php';
					} else {
		...
		<div class="table-responsive">
			<?php
				if ($modules->isInstalled('CaseBottleQty')) {
					include $config->paths->siteModules.'CaseBottleQty/content/customer/sales-history/table.php';
				} else {
