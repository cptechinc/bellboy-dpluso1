    ...
    switch ($page->name) { //$page->name is what we are printing
        case 'order':
			...
			if ($modules->isInstalled('CaseBottleQty')) {
                $page->body = $config->paths->siteModules.'CaseBottleQty/content/print/sales-order.php';
            } else {
        ...
        case 'quote':
            ...
            if ($modules->isInstalled('CaseBottleQty')) {
                $page->body = $config->paths->siteModules.'CaseBottleQty/content/print/quotes.php';
            } else {
